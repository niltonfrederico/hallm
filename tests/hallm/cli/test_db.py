...
from tests.mocks import async_context_mock
...
class TestBootstrap:
    ...
    def test_runs_each_sql_file_in_order(self, tmp_path: Path, runner: CliRunner) -> None:
    ...
    def test_substitutes_placeholders_in_sql(self, tmp_path: Path, runner: CliRunner) -> None:
    ...
    def test_reports_bootstrap_complete_on_success(self, tmp_path: Path, runner: CliRunner) -> None:
    ...
    def test_connection_os_error_exits_with_1(self, tmp_path: Path, runner: CliRunner) -> None:
        (tmp_path / "init.sql").write_text("SELECT 1;")
    ...
    def test_postgres_error_exits_with_1(self, tmp_path: Path, runner: CliRunner) -> None:
        (tmp_path / "init.sql").write_text("SELECT 1;")
    ...
    def test_unknown_placeholder_exits_with_1(self, tmp_path: Path, runner: CliRunner) -> None:
